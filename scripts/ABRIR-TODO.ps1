...
# Ejecutar: doble clic en ABRIR-ENLACES.bat (raíz del proyecto)
...
Write-Host "  BLACK COFFEE — Abriendo enlaces en el navegador" -ForegroundColor Cyan
Write-Host "==================================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "Listo. Revisa las pestañas del navegador." -ForegroundColor Green
Write-Host "Correo notificaciones: ghostspecialtycoffee@gmail.com" -ForegroundColor Yellow
Write-Host ""
