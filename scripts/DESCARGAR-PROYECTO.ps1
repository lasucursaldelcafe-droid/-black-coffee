...
# O pegar en PowerShell: irm https://raw.githubusercontent.com/lasucursaldelcafe-droid/-black-coffee/main/scripts/DESCARGAR-PROYECTO.ps1 | iex
...
if ($Abrir -ne 'n' -and $Abrir -ne 'N') {
    & (Join-Path $CarpetaDestino 'ABRIR-ENLACES.bat')
}
